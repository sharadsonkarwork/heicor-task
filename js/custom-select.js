...
function createSelect() {
    var select = document.getElementsByTagName('select'),
      ...
      for (var i = 0; i < select[select_i].options.length; i++) {
        ...
        liElement.className = 'select-dropdown-list-item';
    ...
    function wrapElement(el, wrapper, i, placeholder) {
      ...
      document.addEventListener('click', function (e) {
        ...
        if (!clickInside) {
          let menu = wrapper.getElementsByClassName('select-dropdown-list');
      ...
      buttonElement.className = 'select-dropdown-button select-dropdown-button--' + i;
      buttonElement.setAttribute('data-value', '');
      buttonElement.setAttribute('type', 'button');
      spanElement.className = 'select-dropdown select-dropdown--' + i;
      iElement.className = 'zmdi zmdi-chevron-down';
      ulElement.className = 'select-dropdown-list select-dropdown-list--' + i;
      ulElement.id = 'select-dropdown-list-' + i;
    ...
    var buttonSelect = document.getElementsByClassName('select-dropdown-button');
